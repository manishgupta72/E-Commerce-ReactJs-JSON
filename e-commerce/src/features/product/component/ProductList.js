        ...
        <div className="flex flex-1 justify-between sm:hidden">
          <div
           onClick={(e) => handlePage(page > 1 ? page - 1 : page)}
            className={`relative ml-3 inline-flex items-center rounded-md border border-gray-300 ${page!==1?'bg-white hover:bg-gray-50':'bg-gray-600'}  px-4 py-2 text-sm font-medium text-gray-700 `}
          >
            Previous
          </div>
          <div
             onClick={(e) => handlePage(page < totalPage ? page + 1 : page)}
            className={`relative ml-3 inline-flex items-center rounded-md border border-gray-300 ${page<totalPage?'bg-white hover:bg-gray-50':'disabled'}  px-4 py-2 text-sm font-medium text-gray-700 `}
          >
            Next
          </div>
        </div>
            ...
            >
              ...
              {Array.from({
                ...
                <div
                  ...
                  aria-current="page"
                  className={`relative z-10  border cursor-pointer inline-flex items-center ${
                    index + 1 === page
                      ? "bg-indigo-600 text-white"
                      : "bg-amber-200 text-orange-950"
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
              {products.map((product) => (
                <Link to={`/product-details/${product.id}`} key={product.id}>
                  <div className="group relative border-solid border-2 p-3">
